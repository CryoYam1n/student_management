...
<body class="bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 min-h-screen">
    <nav class="bg-white shadow">
        <div class="max-w-5xl mx-auto px-4 py-4 flex justify-between items-center">
            <a class="text-2xl font-bold text-blue-700" href="#">Add User</a>
    ...
    <div class="max-w-xl mx-auto mt-10 bg-white/90 rounded-3xl shadow-2xl p-10 border border-blue-100 backdrop-blur-md">
        <h2 class="text-3xl font-extrabold text-blue-700 mb-6 text-center">Add New User</h2>
        <form method="POST" class="space-y-5">
            ...
            <button type="submit" name="add_user" class="w-full py-2 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white font-bold rounded-xl shadow-lg transition-all duration-200">Add User</button>
        </form>
    </div>
</body>
</html>
